...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/crypto_bot_ui_beta
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/crypto_bot_ui_beta_test
```
